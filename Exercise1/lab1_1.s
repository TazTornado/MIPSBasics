...
strEnd: la $a0,ans          # system call to print
        ...
        li $v0,10           # system call to end/exit program
        syscall             # au revoir...
...
##########################
.data                       ########################################
str: .asciiz "hello world"  # str, ans and endl are labels         #
ans: .asciiz "Length is "   # corresponding to the memory address  #
endl: .asciiz "\n"          # where each string lies               #
                            ########################################
